...
if __name__ == "__main__":
    ...
    new_csv_weightage_file1 = csv_file_clean("/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_classified_data1.csv", columns_removed_for_literacy, "/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_literacy.csv")
    new_csv_weightage_file2 = csv_file_clean("/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_classified_data1.csv", columns_removed_for_behaviour, "/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_behaviour.csv")
    new_csv_weightage_file3 = csv_file_clean("/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_classified_data1.csv", columns_removed_for_income, "/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_income.csv")

    files = ["/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_income.csv", "/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_literacy.csv", "/home/atrivedi/Investment-Predictions/Datasets/Investment_Prediction_without_behaviour.csv"]

    values = ["Report after removing Income", "Report after removing Literacy", "Report after removing Behaviour"]
