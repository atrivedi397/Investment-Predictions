...
def logistic_classifier_and_prediction(csv_file=None, classified_dataframe=None):
    ...
    return y_pred, y_train, clf, classification_report(y_test, y_pred), confusion_matrix(y_test, y_pred), accuracy_score(
        y_test, y_pred)
...
def linear_classifier_and_prediction(csv_file=None, classified_dataframe=None):
    ...
    return new_y_pred, y_train, clf, classification_report(y_test, new_y_pred), confusion_matrix(y_test, new_y_pred), accuracy_score(y_test, new_y_pred)
